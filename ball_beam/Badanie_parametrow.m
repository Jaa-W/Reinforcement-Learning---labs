...
%% Zmienione
gamma           = 0.995;               % współczynnik dyskontowania
alpha           = 0.2;                 % współczynnik aktualizacji funkcji Q
beta            = 0.05;                % współczynnik aktualizacji funkcji r_srednia
lambda          = 0.9;                 % współczynnik świeżości funkcji Q
...
legend('Q(λ)-learning α = 0.1','Q(λ)-learning α = 0.2',...
    'R(λ)-learning α = 0.1','R(λ)-learning α = 0.2',...
    'AHC(λ)-learning λ = α = 0.1','AHC(λ)-learning α = 0.2');
title("Kulka balansująca na równoważni (γ = 0.995, α = var, β = 0.05, λ = 0.9)");
